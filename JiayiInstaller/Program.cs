...
Console.WriteLine("If you'd like to install to a different location, enter it now.");
...
Console.WriteLine("If you'd like to create a desktop shortcut as well, type \"desktop\".");
Console.WriteLine("Otherwise, press enter to continue.");
Console.Write("> ");
